import chooseUs from '@/assets/Why_choos_us.gif';
    ...
    <div className="max-w-5xl mx-auto">
      <div className="md:mt-16 mt-6 px-2 md:px-0 ">
        ...
        <p className="md:text-center text-justify text-xs md:text-base font-medium mt-3 max-w-4xl mx-auto px-4 md:px-0 ">
          Top notch quality coupled with unwavering reliability makes Baraqa
          Property Services LLC your trusted partner in property maintenance. We
          aim to build long term relationships with our customer focused
          approach to services and our team of professionals are meticulous
          about every detail serving with integrity and professionalism.
        </p>
      </div>
      <div className="md:grid grid-cols-2 items-center gap-3 max-w-6xl mx-auto mb-6 md:mb-16 mt-6 px-3 md:px-0">
        <div className="col-span-1">
          {/* video div */}
          <div className="md:mt-5" id="choosVideo">
            <Image src={chooseUs} alt="why choose us`"/>
          </div>
        </div>
